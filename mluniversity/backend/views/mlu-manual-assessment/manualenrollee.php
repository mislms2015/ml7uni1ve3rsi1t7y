...
?>
      <div class="row">
        ...
        <div class="cell" style="text-align: center;">
          ...
          <?= Html::a('<span class="material-icons">picture_as_pdf </span>', ['mlu-manual-assessment/individualcert', 'id'=>$enrollee_result['id']], ['target' => '_blank', 'class'=>'btn btn-primary', 'title' => 'Training Certificate', 'style' => 'height: 30px;']) ?>
          ...
          <?php // echo Html::a('<span class="material-icons">font_download picture_as_pdf </span>', ['mlu-manual-assessment/attendedcert', 'id'=>$enrollee_result['id']], ['target' => '_blank', 'class'=>'btn btn-success', 'title' => 'Training Attended', 'style' => 'height: 30px;']) ?>
        </div>
      </div>
<?php
endforeach;
