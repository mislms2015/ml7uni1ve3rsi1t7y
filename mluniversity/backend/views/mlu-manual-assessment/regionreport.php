...
<table align='center' style="border-collapse:collapse; font-size:12px;">
    ...
    <tr>
      <td > <font color='$class'> <?=ucwords($training_info['name'])?> </td>
        <td> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </td> 
        <td> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </td>
        <td> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </td> 
      <td style='text-align: center;'> <font color='$class'> <?=date('F j, Y', strtotime($training_info['date_conduct']))?> </td>
        <td> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </td> 
        <td> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </td>
        <td> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </td> 
      <td style='text-align: center;'> <font color='$class'> <?=ucwords($training_info['trainor'])?> </td>
    </tr>
    <tr> <td colspan=9> <hr /> </td> </tr>
</table>
...
?>
    <tr>
      ...
      <td style='text-align: center; font-size: 12px; border-bottom: 1px dashed #ccc;'><?php echo ucwords($attendee_result['area'])?></td>
    </tr>
<?php
endforeach;
?>
