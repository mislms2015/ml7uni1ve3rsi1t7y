...
class MluManualAssessmentManualSearch extends MluManualAssessment
{
    ...
    public function search($params)
    {
        ...
        $query->orFilterWhere(['like', 'mlu_manual_assessment.fname', $this->globalSearch])
              ...
              //->andFilterWhere(['mlu_manual_assessment.training_id' => $this->manual_id]);
              //->andFilterWhere(['=', 'mlu_manual_assessment.training_id', 11]);
